...
I am a data science teaching faculty and PhD research fellow at [Northeastern University](https://www.northeastern.edu/) focusing on applied machine learning techniques. I also design and teach graduate-level courses in [IE7275 data mining]({{ "/ie7275-bos-sm20/" | relative_url }}) and [IE6600 Computation and Visualization for Analytics]({{ "/ie6600-bos-fa20/" | relative_url }}) to prepare graduate students doing research, team projects and future career.
