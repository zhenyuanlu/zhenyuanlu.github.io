...
Hi! I'm a data science instructor and [PhD research fellow](https://phd.northeastern.edu/profile/zhenyuan-lu/) at [Northeastern University](https://www.northeastern.edu/) worked with [Prof. Sagar Kamarthi](https://coe.northeastern.edu/people/kamarthi-sagar/). In order to prepare graduate students for their work on research projects, and future careers, I also create and instruct graduate-level courses in [IE7275 data mining]({{ "/courses/ie7275-bos-sm20/" | relative_url }}) and [IE6600 Computation and Visualization for Analytics]({{ "/courses/ie6600-bos-fa20/" | relative_url }}). The College of Engineering department interviewed and spotlighted me for the [student success story](https://coe.northeastern.edu/news/ready-for-the-high-demand-field-of-data-analytics/), and my research motivation and goals are also highlighted on the [University PhD Network](https://phd.northeastern.edu/profile/zhenyuan-lu/).
